...
if __name__ == "__main__":
    ...
    try: 
        ...
        print()
        model =  RandomForestRegressor(n_estimators=args.n_estimators, random_state=args.random_state, verbose = 1,n_jobs=-1)
        ...
        # Optionally, re-raise the exception to ensure it shows up in logs
        raise